// src/app/f/page.tsx
// PUBLIC 会员月费自查 (D5) — no login. Screen 1: phone → 查询. Screen 2: for each ACTIVE member on
// that phone — MASKED name, centre + pledge, a big gold 已付至 card (waived → 豁免中, kind wording,
// never an amount due), 缴付记录, and the centre's current-month transparency block (paused →
// 本月已满，感恩 🙏). No records → a warm 查无记录 message. All data from POST /api/public/fee-lookup.
