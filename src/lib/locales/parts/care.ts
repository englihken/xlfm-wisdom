...
const zh = {
  ...
  // ── 未回复 (别再把访客弄丢) ───────────────────────────────────────────────
  'care.filterUnanswered': '未回复',
  'care.filterCare': '关怀跟进',
  'care.emptyCare': '暂无需要关怀跟进的对话 🙏',
  'care.emptyUnanswered': '没有等待回复的对话 🙏',
  'care.unansweredHeader': '等待回复 · {n} 通（等最久的在前，有联系方式的置顶）',
  'care.awaitingReply': '已等待 {t}',
  'care.hasContact': '有联系方式',
  'care.waitMinutes': '{n} 分钟',
  'care.waitHours': '{n} 小时',
  'care.waitDays': '{n} 天',
...
export const carePart: {
  ...
  en: {
    ...
    'care.filterUnanswered': 'Unanswered',
    'care.filterCare': 'Care follow-up',
    'care.emptyCare': 'No conversations flagged for care follow-up 🙏',
    'care.emptyUnanswered': 'No one is waiting for a reply 🙏',
    'care.unansweredHeader': 'Waiting for a reply · {n} (longest wait first, contact details on top)',
    'care.awaitingReply': 'waiting {t}',
    'care.hasContact': 'has contact details',
    'care.waitMinutes': '{n} min',
    'care.waitHours': '{n} h',
    'care.waitDays': '{n} d',
  ...
  id: {
    ...
    'care.filterUnanswered': 'Belum dibalas',
    'care.filterCare': 'Tindak lanjut kepedulian',
    'care.emptyCare': 'Tidak ada percakapan yang perlu ditindaklanjuti 🙏',
    'care.emptyUnanswered': 'Tidak ada yang menunggu balasan 🙏',
    'care.unansweredHeader': 'Menunggu balasan · {n} (terlama di atas, yang ada kontak diutamakan)',
    'care.awaitingReply': 'menunggu {t}',
    'care.hasContact': 'ada kontak',
    'care.waitMinutes': '{n} mnt',
    'care.waitHours': '{n} jam',
    'care.waitDays': '{n} hari',
