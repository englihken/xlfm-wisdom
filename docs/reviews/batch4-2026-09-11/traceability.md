...
生成时间 2026-09-13T07:04:11.614Z。行号 = `src/lib/system-prompt.v1.ts`（与 brief 的 L 号一致）。

- v2 中文非空行 **1997**：追溯到 v1 的 **1909**，C1–C8 新增 **88**，追溯不到 **0**。
- v1 内容行未进 v2 的 **83**：有 C 号依据 83，无依据 0。
- 三张表：合并 350 行、删除 83 行、新增 88 行。
...
| en/tiers | 401/435 | books: 《千手千眼无碍大悲心陀罗尼》、《般若波罗蜜多心经》、《念诵指南》、《佛学问答》、《往生净土神咒》、《七佛灭罪真言》、《补阙真言》、《净口业真言》、《大吉祥天女咒》、《功德宝山神咒》、《白话佛法》、《法会弟子提问》、《解答来信疑惑》；urls: https://xlfm.my/read；prayers: 〈祈求开头〉保佑我（姓名）忏悔消除业障 |
...
| id/tiers | 401/435 | books: 《千手千眼无碍大悲心陀罗尼》、《般若波罗蜜多心经》、《念诵指南》、《佛学问答》、《往生净土神咒》、《七佛灭罪真言》、《补阙真言》、《净口业真言》、《大吉祥天女咒》、《功德宝山神咒》、《白话佛法》、《法会弟子提问》、《解答来信疑惑》；urls: https://xlfm.my/read；prayers: 〈祈求开头〉保佑我（姓名）忏悔消除业障 |
...
| L538 | tiers.ts L157 | 1 |
| L2118–2122 | tiers.ts L159–163 | 5 |
| L2124 | tiers.ts L165 | 1 |
| L2125–2137 | tiers.ts L167–178 | 13 |
| L538 | tiers.ts L181 | 1 |
| L2141 | tiers.ts L183 | 1 |
| L2120 | tiers.ts L185 | 1 |
| L2144–2145 | tiers.ts L186–187 | 2 |
| L2148–2152 | tiers.ts L190–194 | 5 |
| L2130 | tiers.ts L196 | 1 |
| L2155–2157 | tiers.ts L197–199 | 3 |
| L538 | tiers.ts L201 | 1 |
| L2161–2181 | tiers.ts L203–223 | 21 |
| L538 | tiers.ts L226 | 1 |
| L2187–2205 | tiers.ts L228–246 | 19 |
| L538 | tiers.ts L248 | 1 |
| L2042 | tiers.ts L250 | 1 |
| L2451 | tiers.ts L252 | 1 |
| L2454–2468 | tiers.ts L255–269 | 15 |
| L2469–2470 | tiers.ts L273–274 | 2 |
| L2536–2538 | tiers.ts L277–279 | 3 |
| L2540 | tiers.ts L281 | 1 |
| L2543–2547 | tiers.ts L283–287 | 5 |
| L1989 | tiers.ts L289 | 1 |
| L1296–1309 | tiers.ts L291–303 | 14 |
| L206–208 | tiers.ts L306–308 | 3 |
| L1318–1337 | tiers.ts L312–331 | 20 |
| L1374–1399 | tiers.ts L333–357 | 26 |
| L1420–1436 | tiers.ts L359–375 | 17 |
| L2679 | tiers.ts L379 | 1 |
| L2683–2687 | tiers.ts L383–387 | 5 |
| L2691–2696 | tiers.ts L389–394 | 6 |
| L2698–2712 | tiers.ts L396–410 | 15 |
| L2741–2753 | tiers.ts L412–424 | 13 |
| L2640 | tiers.ts L426 | 1 |
| L2757–2762 | tiers.ts L428–433 | 6 |
| L1989 | tiers.ts L435 | 1 |
...
| tiers.ts L148 | ken-0913-fellow | - 固定结构： | §二 同修轮固定结构 |
| tiers.ts L149 | ken-0913-fellow | 1. 一句共情：承认对方在修，点出问题的实质。 | 固定结构 1 |
| tiers.ts L150 | ken-0913-fellow | 2. 师父原文 2–3 段：只用检索到的原文（《白话佛法》《法会弟子提问》《解答来信疑惑》优先），放在「> 」引文块里逐字照抄，不改一个字；书名以该检索段落为准；不同来源不拼成一段；解释放在引文块外。 | 固定结构 2 ＋ §三「引号逐字」 |
| tiers.ts L151 | ken-0913-fellow | 3. 白话讲：这几段怎么用在他的处境，2–4 句。 | 固定结构 3 |
| tiers.ts L152 | ken-0913-fellow | 4. 修行上的建议：用话说，不带遍数张数；迷茫、烦恼一类加一句「多读《白话佛法》」，点到检索到的那一册，并给 https://xlfm.my/read 。 | 固定结构 4 |
| tiers.ts L153 | ken-0913-fellow | 5. 结尾一句菩萨圣号或一句鼓励；不写「查不到相关原文」「资料里没有写明」一类的话。 | 固定结构 5（护栏侧：level=experienced 时 chooseGuardTail 返回 none） |
| tiers.ts L154 | ken-0913-fellow | - **practising（已在念功课、问细节）**：默认不给遍数；访客问「念几遍／几张」或话题本身是教义数字（小房子规格、礼佛特殊日子、369）时才给，给就按功课卡／《佛学问答》161；分诊问题只问会改变建议的；引文 1–2 段。 | §二 表 practising 行 |
| tiers.ts L155 | ken-0913-fellow | - **长者／需要关怀**（年事已高、安老院、身体不好、孤单、家人不修）：句子短、字少，一段师父原文就够；不自创遍数张数（只写有据的数字，或说以义工为准）；结尾邀请义工联系：「共修会的义工可以来看您／打电话给您」。 | §二 长者／需要关怀的信号 |
| tiers.ts L164 | ken-0913-three-pillars | - 礼佛大忏悔文 每天 1 遍（三部默认都开；访客明说怕难／时间少才先开前两部，礼佛几天内加上） | 规则 2：Tier 0「不开礼佛」（addendum-B1）→ 开 1 遍 |
| tiers.ts L166 | C1 | - 很多人先把大悲咒、心经念顺再加，但只要功课开始了，就可以起小房子 | 允许保留的一处软性建议措辞（Tier 0 小房子条目下） |
| tiers.ts L179 | ken-0913-three-pillars | - 礼佛前: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我（姓名）忏悔消除业障" | Tier 0 祈求词示范补礼佛（祈求词照 v1 L1799 关系类原文） |
| tiers.ts L188 | ken-0913-three-pillars | - **礼佛大忏悔文 每天 1 遍起**（Tier 0 已默认开；先前嫌难没开的，这时加上） | v1 L2146 Tier 1「加礼佛 1 遍」与 Tier 0 已开冲突 |
| tiers.ts L224 | C1 | - 需要小房子（门槛见【入门轮硬性规则】第 4 条：功课一开始就可以念） | 替换 L2182–2183「见 Tier 3／先会 4 部经才能做」 |
| tiers.ts L254 | ken-0913-three-pillars | ✅ AI 在同一条回复里先给暂定功课（Tier 0 的三部＋祈求词）,再问: | 模板 A（C3 行）两部 → 三部 |
| tiers.ts L270 | ken-0913-three-pillars | 📿 《礼佛大忏悔文》每天 1 遍 | 模板 B 补第三部 |
| tiers.ts L271 | ken-0913-three-pillars | 念之前说:"祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我（姓名）忏悔消除业障" | 模板 B 礼佛祈求词（照 v1 L1799 原文） |
| tiers.ts L272 | ken-0913-three-pillars | (晚上 10 点至凌晨 5 点不念) | 模板 B 礼佛时间（照 C6／《佛学问答》161） |
| tiers.ts L275 | C1 | 跟着视频念 🙏 | L2471 去掉「坚持 1-2 周。熟悉了再加其他的」 |
| tiers.ts L280 | addendum-B5 | 2. **首轮：同一条回复里给暂定功课，并问有没有念过经** (决定 Tier) | L2539 |
| tiers.ts L282 | C1 | 4. **礼佛从 1 遍开始** | L2541 去掉「(Tier 1 才给)」 |
| tiers.ts L305 | ken-0913-three-pillars | **4. 三大支柱（介绍时三部都要提到；首轮默认三部都开，访客嫌难才先开两部）：** | 规则 2：addendum-B1 标题「首轮可以只开两部」 |
| tiers.ts L310 | ken-0913-three-pillars | 补充说明：访客明说怕难／时间少时，可以说"先念前两部，礼佛大忏悔文几天内加上" | 规则 2：v1 L1316「先念前两部熟悉，等熟了再加」→ 只在嫌难时说 |
| tiers.ts L377 | C3 | ### 📿 Qualify-First 原则（英文同样：暂定功课＋分诊问题在同一条回复里） | L2677 标题「英文也要先问」 |
| tiers.ts L381 | C3 | AI 在同一条回复里给暂定功课（按分档）＋这个问题: | L2681「AI 必须 FIRST 问用户 (不要立刻给完整功课表)」删，问题本身保留 |
| tiers.ts L395 | addendum-B2 | comfortable with these two — there's no fixed timeline — you can add the Repentance Mantra. | L2697 删「(1-2 weeks)」 |
...
| tiers.ts L177 | L2136 | ken-0912-prayer | - 大悲咒前: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我(姓名)身体健康,心情平静" |
| tiers.ts L178 | L2137 | ken-0912-prayer | - 心经前: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我(姓名)开智慧,去除烦恼" |
| tiers.ts L209 | L2167 | ken-0912-prayer | - 祈求: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨帮助我(姓名)与(对方姓名)化解恶缘" |
| tiers.ts L213 | L2171 | ken-0912-prayer | - 祈求: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨帮助我(姓名)超度因我而受害的小灵性" |
| tiers.ts L217 | L2175 | ken-0912-prayer | - 祈求: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我(姓名)心想事成" |
| tiers.ts L221 | L2179 | ken-0912-prayer | - 祈求: "祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我(姓名)消灾吉祥,平安顺利" |
| tiers.ts L265 | L2464 | ken-0912-fullname | 📿 《千手千眼无碍大悲心陀罗尼》（大悲咒）每天 3 遍 |
| tiers.ts L266 | L2465 | ken-0912-prayer | 念之前说:"祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我(姓名)身体健康,心情平静" |
| tiers.ts L267 | L2466 | ken-0912-fullname | 📿 《般若波罗蜜多心经》（心经）每天 3 遍 |
| tiers.ts L268 | L2467 | ken-0912-prayer | 念之前说:"祈请南无大慈大悲救苦救难广大灵感观世音菩萨摩诃萨保佑我(姓名)开智慧,去除烦恼" |
| tiers.ts L306 | L206 | ken-0912-fullname | - 《千手千眼无碍大悲心陀罗尼》（大悲咒）—— 身体健康，增强能量 |
| tiers.ts L307 | L207 | ken-0912-fullname | - 《般若波罗蜜多心经》（心经）—— 开智慧，去除烦恼 |
