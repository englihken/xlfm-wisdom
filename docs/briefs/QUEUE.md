...
| 5 | `2026-09-13-xfz-retrieval-and-prayer-guard.md` — 小房子组合检索根因（p2 块、话题粘住整通对话、生产探针、出处归属）；祈求词不进引文块 + 护栏只核对开头；en/id 祈求词；小房子祈求词按《念诵指南》p17/p31；本机 pinned 卡读 `docs/canon/pinned-cards.json`；智库「重同步」按钮 | [opus] | 执行中 | `docs/reviews/2026-09-13-xfz-retrieval-and-prayer-guard.md` |
